...
export default function MenuBox({ setShowPostSection }: { setShowPostSection: Dispatch<SetStateAction<boolean>> }) {
    ...
    return (
        <ul className="flex flex-col gap-4 self-end mr-4 ">
            <div className='px-4 py-2 w-48 border border-[#212427] rounded-[10px] h-12 flex items-center justify-between'>
            <input className=" w-[80%] h-11 bg-transparent outline-none text-[14px] border-none text-white focus:outline-none focus:border-none" type="text" placeholder="Search" />
...
<path d="M18.3327 18.3337L16.666 16.667M9.58268 17.5003C10.6223 17.5003 11.6518 17.2956 12.6123 16.8977C13.5728 16.4999 14.4455 15.9167 15.1806 15.1816C15.9157 14.4465 16.4989 13.5737 16.8967 12.6132C17.2946 11.6527 17.4993 10.6233 17.4993 9.58366C17.4993 8.54403 17.2946 7.51458 16.8967 6.55408C16.4989 5.59359 15.9157 4.72086 15.1806 3.98573C14.4455 3.2506 13.5728 2.66746 12.6123 2.26961C11.6518 1.87176 10.6223 1.66699 9.58268 1.66699C7.48305 1.66699 5.46942 2.50107 3.98475 3.98573C2.50009 5.47039 1.66602 7.48403 1.66602 9.58366C1.66602 11.6833 2.50009 13.6969 3.98475 15.1816C5.46942 16.6663 7.48305 17.5003 9.58268 17.5003V17.5003Z" stroke="#6A6A6A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <Link href="/feed" passHref>
                {
                    !flag ? <li className="flex items-center gap-3 cursor-pointer px-2 py-3">
                        {/* <i className={`ri-home-6-fill text-2xl ${route.pathname === '/feed'?  'text-gradient' : 'text-white/30'}`}></i> */}
                        {/* <svg className="text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="m9.02 2.84-5.39 4.2C2.73 7.74 2 9.23 2 10.36v7.41c0 2.32 1.89 4.22 4.21 4.22h11.58c2.32 0 4.21-1.9 4.21-4.21V10.5c0-1.21-.81-2.76-1.8-3.45l-6.18-4.33c-1.4-.98-3.65-.93-5 .12ZM12 17.99v-3"  strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"
                            ></path>
                        </svg> */}
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <path d="m9.02 2.84-5.39 4.2C2.73 7.74 2 9.23 2 10.36v7.41c0 2.32 1.89 4.22 4.21 4.22h11.58c2.32 0 4.21-1.9 4.21-4.21V10.5c0-1.21-.81-2.76-1.8-3.45l-6.18-4.33c-1.4-.98-3.65-.93-5 .12ZM12 17.99v-3"
                                stroke={` ${route.pathname === '/feed' ? 'url(#a)' : '#6a6a6a'}  `}
                                strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                        </svg>
                        <span className={` text-[14px] font-medium ${route.pathname === '/feed' ? 'text-gradient' : 'text-white/30'}`}>Home</span>
                    </li> :
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <defs>
...

            {
                !flag ?
                    <Link href='/messages' passHref>
                        <li className="flex items-center gap-3 cursor-pointer px-2 py-3">
                            {/* <i className={`ri-message-2-fill text-2xl ${route.pathname === '/messages' ? 'text-gradient' : 'text-white/30'}`}></i> */}
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <defs>
                                    <linearGradient id="a">
                                        <stop offset="0" stopColor="#84B9D1" />
                                ...
                                <path d="M8.5 19H8c-4 0-6-1-6-6V8c0-4 2-6 6-6h8c4 0 6 2 6 6v5c0 4-2 6-6 6h-.5c-.31 0-.61.15-.8.4l-1.5 2c-.66.88-1.74.88-2.4 0l-1.5-2c-.16-.22-.53-.4-.8-.4Z"
                                    stroke={` ${route.pathname === '/messages' ? 'url(#a)' : '#6a6a6a'}  `}
                                    strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
                                <path d="M15.996 11h.01M11.995 11h.01M7.995 11h.008" stroke={` ${route.pathname === '/messages' ? '#AEB6E8' : '#6a6a6a'}  `}
                                    strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                            </svg>
                            <span className={` text-[14px] font-medium ${route.pathname === '/messages' ? 'text-gradient' : 'text-white/30'}`}>Messages</span>
                        </li>
                    </Link> :
...

            {
                ...
                <Link href="/groups" passHref>
                    <li className="flex items-center gap-3 cursor-pointer px-2 py-3">
                        {/* <i className={`ri-group-fill text-2xl ${route.pathname === '/groups' ? 'text-gradient' : 'text-white/30'}`}></i> */}
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <defs>
                                <linearGradient id="a">
                                    <stop offset="0" stopColor="#84B9D1" />
                            ...
                            <path d="M9.16 10.87c-.1-.01-.22-.01-.33 0a4.42 4.42 0 0 1-4.27-4.43C4.56 3.99 6.54 2 9 2a4.435 4.435 0 0 1 .16 8.87ZM16.41 4c1.94 0 3.5 1.57 3.5 3.5 0 1.89-1.5 3.43-3.37 3.5a1.13 1.13 0 0 0-.26 0M4.16 14.56c-2.42 1.62-2.42 4.26 0 5.87 2.75 1.84 7.26 1.84 10.01 0 2.42-1.62 2.42-4.26 0-5.87-2.74-1.83-7.25-1.83-10.01 0ZM18.34 20c.72-.15 1.4-.44 1.96-.87 1.56-1.17 1.56-3.1 0-4.27-.55-.42-1.22-.7-1.93-.86"
                                stroke={` ${route.pathname === '/groups' ? 'url(#a)' : '#6a6a6a'}  `}
                                strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                        </svg>
                        <span className={` text-[14px] font-medium ${route.pathname === '/groups' ? 'text-gradient' : 'text-white/30'}`}>Communities</span>
                    </li>
                </Link>
            }
...

            {
                !flag ?
                    <Link href={`/${username}`} passHref>
                        <li className="flex items-center gap-3 cursor-pointer px-2 py-3">
                            {/* <i className={`ri-user-fill text-2xl ${route.pathname === '/[profile]' ? 'text-gradient' : 'text-white/30'}`}></i> */}
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <defs>
                                    <linearGradient id="a">
                                        <stop offset="0" stopColor="#84B9D1" />
                                ...
                                <path d="M12.16 10.87c-.1-.01-.22-.01-.33 0a4.42 4.42 0 0 1-4.27-4.43C7.56 3.99 9.54 2 12 2a4.435 4.435 0 0 1 .16 8.87ZM7.16 14.56c-2.42 1.62-2.42 4.26 0 5.87 2.75 1.84 7.26 1.84 10.01 0 2.42-1.62 2.42-4.26 0-5.87-2.74-1.83-7.25-1.83-10.01 0Z"
                                    stroke={` ${route.pathname === `/${username}` ? 'url(#a)' : '#6a6a6a'}  `}
                                    strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
                            </svg>
                            <span className={` text-[14px] font-medium ${route.pathname === `/${username}` ? 'text-gradient' : 'text-white/30'}`}>Profile</span>
                        </li>
                    </Link> :
                    <Link href='/messages' passHref>
                        <li>
...

            {
                !flag ?
                    <Link href="/settings" passHref>
                        <li className="flex items-center gap-3 cursor-pointer px-2 py-3">
                            {/* <i className={`ri-more-fill text-2xl ${route.pathname === '/settings' ? 'text-gradient' : 'text-white/30'}`}></i> */}
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <defs>
                                    <linearGradient id="a">
                                        <stop offset="0" stopColor="#84B9D1" />
                                ...
                                <path d="M5 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2ZM19 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2ZM12 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2Z"
                                    stroke={` ${route.pathname === '/settings' ? 'url(#a)' : '#6a6a6a'}  `}
                                    strokeWidth="1.5"></path>
                            </svg>
                            <span className={` text-[14px] font-medium ${route.pathname === '/settings' ? 'text-gradient' : 'text-white/30'}`}>More</span>
                        </li>
                    </Link> :
                    <Link href="/groups" passHref>
                        <li>
